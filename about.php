    ...
    <body id="About-Page" class="basic-page">
        ...
        <section id="ContentBody">
            <div class="inner-wrapper">
                ...
                <img class="awards" src="img/awards.png" alt="Mustafa's Awards">
                ...
                <p>Mustafa has brought together a team of first-rate professionals to provide exceptional comprehensive service in real estate. From our in-house marketing department to staging professionals, Mustafa’s team is dedicated to providing a service of excellence. Talented and knowledgeable, the team members gather inspiration from Mustafa’s vision and are fully dedicated to the needs of our clients and friends.</p>
