...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Mustafa Zia | Investing in Real Estate</title>
        <meta name="description" content="Mustafa Zia - Advice and information on investing on Real Estate.">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <meta property="og:type"  content="website" />
        <meta property="og:url"   content="<?php echo "http://" . $_SERVER[HTTP_HOST] . $_SERVER[REQUEST_URI]; ?>" />
        <meta property="og:title" content="Mustafa Zia | Investing in Real Estate" />
    ...
    <body id="Investing-Page" class="basic-page">
